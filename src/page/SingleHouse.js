          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-7 grid-cols-1 gap-4">
            <div className="lg:col-span-3 flex flex-col w-full">
                      ...
                      <button
                        ...
                        className={`${
                          variant?.id === variantInfo.id
                            ? "mx-2 px-4 text-[30px] border-2 border-black hover:bg-black bg-black text-white hover:text-white rounded-md my-2"
                            : "mx-2 px-4 text-[30px] border-2 border-black hover:bg-black hover:text-white rounded-md my-2"
                        }`}
                        onClick={() => {
              ...
              <button
                ...
                className="border-2 border-white hover:border-black hover:bg-black text-white py-3 rounded-md my-2 uppercase"
              >
